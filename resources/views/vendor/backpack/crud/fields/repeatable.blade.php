  ...
  @push('crud_fields_scripts')
      ...
      <script>
        ...
        function bpFieldInitRepeatableElement(element) {
            ...
            $('input[type=hidden][name='+$.escapeSelector(field_name)+']').first().on('CrudField:disable', function() {
                disableRepeatableContainerFields(container_holder);
            });

            $('input[type=hidden][name='+$.escapeSelector(field_name)+']').first().on('CrudField:enable', function() {
        ...
        function triggerRepeatableInputChangeEvent(repeatable) {
            ...
            $('input[type=hidden][name='+$.escapeSelector($(repeatable).attr('data-repeatable-holder'))+']').first().trigger('change', [values]);
        }
